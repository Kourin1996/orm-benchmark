...
const (
	// Label holds the string label denoting the models type in the database.
	Label = "models"
	...
	// Table holds the table name of the models in the database.
	Table = "models"
)

// Columns holds all SQL columns for models fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldTitle,
