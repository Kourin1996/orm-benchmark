...
type Model struct {
	...
	Web     null.String `boil:"web" json:"web,omitempty" toml:"web" yaml:"web,omitempty"`
	Age     null.Int    `boil:"age" json:"age,omitempty" toml:"age" yaml:"age,omitempty"`
	Right   null.Bool   `boil:"right" json:"right,omitempty" toml:"right" yaml:"right,omitempty"`
	Counter null.Int64  `boil:"counter" json:"counter,omitempty" toml:"counter" yaml:"counter,omitempty"`
...
var ModelWhere = struct {
	...
	Web     whereHelpernull_String
	Age     whereHelpernull_Int
	Right   whereHelpernull_Bool
	Counter whereHelpernull_Int64
}{
	ID:      whereHelperint{field: "\"models\".\"id\""},
	Name:    whereHelpernull_String{field: "\"models\".\"name\""},
	Title:   whereHelpernull_String{field: "\"models\".\"title\""},
	Fax:     whereHelpernull_String{field: "\"models\".\"fax\""},
	Web:     whereHelpernull_String{field: "\"models\".\"web\""},
	Age:     whereHelpernull_Int{field: "\"models\".\"age\""},
	Right:   whereHelpernull_Bool{field: "\"models\".\"right\""},
	Counter: whereHelpernull_Int64{field: "\"models\".\"counter\""},
}
